<template>
  ...
  <form>
    <div class="list" @click="showMessage(city.name,city.ProID)" v-for="city in projson">
        {{city.name}} <span></span>
    </div>
  </form>
  </div>
